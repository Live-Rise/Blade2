# build-0800.ps1 - Release MSIX build for Blade2 0.8.1 (ASCII only)
...
$msix = Get-ChildItem $pkgDir -Recurse -Filter '*_0.8.1_x64*.msix' | Select-Object -First 1
if (-not $msix) { $msix = Get-ChildItem $pkgDir -Recurse -Filter '*.msix' | Where-Object { $_.FullName -like '*0.8.1*' } | Sort-Object LastWriteTime -Descending | Select-Object -First 1 }
