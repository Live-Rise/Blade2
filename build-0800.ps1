...
$msix = Get-ChildItem $pkgDir -Recurse -Filter '*_0.8.0_x64*.msix' | Select-Object -First 1
if (-not $msix) { $msix = Get-ChildItem $pkgDir -Recurse -Filter '*.msix' | Where-Object { $_.FullName -like '*0.8.0*' } | Sort-Object LastWriteTime -Descending | Select-Object -First 1 }
